...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            input_feature_train_arr: np.ndarray = preprocessor.fit_transform(input_feature_train_df)
            logging.info("Initializing transformation for Testing-data")
            input_feature_test_arr: np.ndarray = preprocessor.transform(input_feature_test_df)
            logging.info("Transformation done end to end for train-test dfs")
            ...
            logging.info('SMOTTENN applied to train df')
            # not applying Resampling to test data(necessary to maintain real world distribution)
            logging.info("SMOTEENN application done.")
