...
from src.cloud_storage.aws_storage import ModelS3
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[ModelS3]:
        """
        This function is used to get model from production stage and
        outputs model object if available in s3 storage
        """
        try:
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            save_object('artifacts/model_evaluation/model_evaluation_report.pkl', model_evaluation_artifact)
